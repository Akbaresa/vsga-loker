                        ...
                        <div class="card-body">
                            <div class="row g-3 mb-3">
                                @foreach($statusList as $status)
                                    <a type="button" href="/karyawan/laporan/progress?status_project={{ $status->id_status_project }}" class="col-12">
                                        <div class="card border round mb-0">
                                            <div class="d-flex">
                                                <div class="rounded" style="width: 10px; background-color: {{ $status->warna }};"></div>
                                                <div class="card-body p-3 flex-grow-1">
                                                    <div class="d-flex align-items-center justify-content-between gap-1">
                                                        <h6 class="mb-0">{{ $status->nama_status_project }}</h6>
                                                    ...
                                                    <p>Total Progress : {{ $status->progress_total }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
